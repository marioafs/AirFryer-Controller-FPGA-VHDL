...
-- *****************************************************************************
-- Generated on "05/28/2024 15:22:26"
...
BEGIN
	...
	upTemp <= '0';
WAIT;
END PROCESS t_prcs_upTemp;

-- downTemp
t_prcs_downTemp: PROCESS
BEGIN
	downTemp <= '0';
	WAIT FOR 60000 ps;
	downTemp <= '1';
